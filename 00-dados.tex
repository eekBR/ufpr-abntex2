...
%\newcommand{\lsiglas}{
%\begin{siglas}
%   \item [AEC] Arquitetura, Engenharia e Construção.
%   \item [API] Application Programming Interface ou Interface de Programação de Aplicativo.
...
%   \item [IDE] Integrated Development Environment ou Ambiente de Programação Integrado.
%   \item [IFC] Industry Foundation Classes.
%   \item [ISO] International Organization for Standartization ou Organização Internacional de      Normalização.
%   \item [SPOC] Semana Paranaense de Obra Civis.
%   \item [TI] Tecnologia da Informação.
%   \item [UFPR] Universidade Federal do Paraná.
%   \item [VBA] Visual Basic Application.
%   \item [VPL] Visual Programming Language ou Linguagem de Programação Visual.
%   \item [2D] 2 Dimensões (2D, 3D, 4D, 5D, ...).
%\item[FFT] Transformadas R\'apidas de Fourier. 
%\end{siglas}  
%}
