...
Para inserir um elemento gráfico gerado/compativel com o \LaTeX, você tem o comando imagem com 7 parâmetros que está definido no arquivo 00-pacotesOpcionais.tex:
